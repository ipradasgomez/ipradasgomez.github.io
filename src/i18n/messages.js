// UI strings (not content). Content lives in public/data/profile.json.
export const messages = {
  es: {
    ...
    sections: {
      home: { index: '01', kicker: 'Inicio' },
      about: { index: '02', kicker: 'Perfil' },
      experience: { index: '03', kicker: 'Trayectoria' },
      blog: { index: '04', kicker: 'Escritos' },
      contact: { index: '05', kicker: 'Contacto' },
    },
    ...
    footer: {
      ...
      nav: 'Navegación',
      built: 'Diseñado y construido por Ismael Pradas.',
  ...
  en: {
    ...
    sections: {
      home: { index: '01', kicker: 'Home' },
      about: { index: '02', kicker: 'Profile' },
      experience: { index: '03', kicker: 'Career' },
      blog: { index: '04', kicker: 'Writing' },
      contact: { index: '05', kicker: 'Contact' },
    },
    ...
    footer: {
      ...
      nav: 'Navigation',
      built: 'Designed and built by Ismael Pradas.',
